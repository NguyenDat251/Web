...
(function (root, factory) {
    ...
    "use strict";
    var Imgur2 = function (options) {
        if (!this || !(this instanceof Imgur2)) {
            return new Imgur2(options);
        }
        ...
        this.dropzone = document.querySelectorAll('.dropzone2');
        this.info = document.querySelectorAll('.info2');
        //this.dropzone = document.getElementById('dropzone1);
        //this.info = document.getElementById('.info1');
    ...
    Imgur2.prototype = {
        ...
        createDragZone: function () {
            ...
            p1 = this.createEls('p', {}, 'Kéo ảnh vào đây');
            p2 = this.createEls('p', {}, 'Hoặc chọn đường dẫn của ảnh');
        ...
        loading: function () {
            ...
            img = this.createEls('img', {className: 'loading-image', src: '/css/css_imgur/loading-spin.svg'});
